...
import { z } from 'zod';
import { X, Plus, Trash2, Clock, Calendar, Target, Sparkles, Wand2 } from 'lucide-react';
...
export default function ScheduleForm({ 
  ...
  const generateWithAI = async () => {
    ...
    try {
      const response = await aiApi.generateSchedule(selectedAccountId);
  ...
  const checkNextGeneratableWeek = async () => {
